...
add_action('admin_menu', 'redeme_admin');

function redeme_admin()
{
...
?>
    ...
    <form class="redemeForm" class="wrap" onsubmit="redemeTicket()">
        <h2><?= _('Events Redeem') ?></h2>
        <div class="ticket-redeame">
            <div class="ticket-redeame-field">
                ...
                <input type="text" id="ticketCode" width="400" style="font-size: 1.5em;text-align: center" placeholder="Ingrese su ticket">
                <button type="submit" class="btn-submit" onclick="redemeTicket()">&nbsp;&nbsp;&nbsp;<?= __("BUSCAR", "sp") ?>&nbsp;&nbsp;&nbsp;</button>
            </div>
            <br>
            <br>
            <br>
            ...
            <!-- <div class="ticket-redeame-list">
                <div class="ticket">
                    <b class="ticket--eventname">Evento</b> &nbsp;
                    <span class="ticket--code">00125</span> &nbsp;
                    <span class="ticket--status">
                        <span class="ticket--available">DISPONIBLE</span>
                    </span>
                </div>
            </div> -->
        </div>
    ...
    <script type="text/javascript">
        ...
        jQuery(".redemeForm").on("submit", redemeTicket);
        hideSearchList();
        ...
        function redemeTicket() {
            ...
            calltimeout = setTimeout(function() {
                ...
                let url = home_url("/wp-json/wctvApi/v1/redemeTicket");
                const code = jQuery("#ticketCode").val();
                const eventId = jQuery('#ticketEventTpm').val();
                if (!code) {
                    return
                }
                jQuery.post(url, {
